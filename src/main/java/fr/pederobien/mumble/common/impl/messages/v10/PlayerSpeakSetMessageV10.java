...
public class PlayerSpeakSetMessageV10 extends MumbleMessage {
	 ...
	 */
	protected PlayerSpeakSetMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.PLAYER_SPEAK_SET, header);
	}
