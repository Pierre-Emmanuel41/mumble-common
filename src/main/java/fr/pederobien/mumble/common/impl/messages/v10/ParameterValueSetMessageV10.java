...
public class ParameterValueSetMessageV10 extends MumbleMessage {
	 ...
	 */
	protected ParameterValueSetMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.PARAMETER_VALUE_SET, header);
	}
	...
	public IMessage parse(byte[] payload) {
		...
		newValue = parameterType.getValue(wrapper.extract(first, parameterType.size()));
