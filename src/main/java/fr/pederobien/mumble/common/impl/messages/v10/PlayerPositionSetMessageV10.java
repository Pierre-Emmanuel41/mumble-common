...
public class PlayerPositionSetMessageV10 extends MumbleMessage {
	 ...
	 */
	protected PlayerPositionSetMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.PLAYER_POSITION_SET, header);
	}
