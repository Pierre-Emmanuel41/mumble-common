...
public class ChannelsPlayerRemoveMessageV10 extends MumbleMessage {
	 ...
	 */
	protected ChannelsPlayerRemoveMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.CHANNELS_PLAYER_ADD, header);
	}
