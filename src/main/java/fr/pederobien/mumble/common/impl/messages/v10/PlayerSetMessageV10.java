...
public class PlayerSetMessageV10 extends MumbleMessage {
	 ...
	 */
	protected PlayerSetMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.PLAYER_SET, header);
	}
	...
	public void setProperties(Object... properties) {
		...
		// Player's online status
		boolean isOnline = (boolean) properties[1];
