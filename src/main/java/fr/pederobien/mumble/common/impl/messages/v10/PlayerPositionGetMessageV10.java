...
import fr.pederobien.mumble.common.impl.model.PlayerInfo.CoordinatePlayerInfo;
import fr.pederobien.mumble.common.interfaces.IMumbleHeader;
import fr.pederobien.utils.ByteWrapper;

public class PlayerPositionGetMessageV10 extends MumbleMessage {
	 ...
	 */
	protected PlayerPositionGetMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.PLAYER_POSITION_GET, header);
	}
