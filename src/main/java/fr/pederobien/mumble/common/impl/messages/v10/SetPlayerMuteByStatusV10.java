...
public class SetPlayerMuteByStatusV10 extends MumbleMessage {
	 ...
	 */
	protected SetPlayerMuteByStatusV10(IMumbleHeader header) {
		super(MumbleIdentifier.SET_PLAYER_MUTE_BY, header);
	}
