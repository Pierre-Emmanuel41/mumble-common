...
public class PlayerOnlineSetMessageV10 extends MumbleMessage {
	private String playerName;
	private boolean isOnline;

	protected PlayerOnlineSetMessageV10(IMumbleHeader header) {
		super(MumbleProtocolManager.PLAYER_ONLINE_SET, header);
	}
